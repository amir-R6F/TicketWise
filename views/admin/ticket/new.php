...
$parent_department = $department_manager->get_parent_department();
?>
            ...
            <div id="post-body" class="metabox-holder columns-2">
                        ...
                        <div id="titlediv">
                            <div id="titlewrap">
                                <input type="text" id="title" name="title"
                                       value="<?php echo $is_edit ? esc_attr($ticket->title) : null ?>"
                                       placeholder="عنوان تیکت" autocomplete="off">
                            </div>
                        </div>
                        <div id="postdivrich">
                                ...
                                <div>
                                    <table>
                                            ...
                                            <td>
                                                <select id="tkt-status" name="status">
                                                    ...
                                                    <?php foreach ($statuses as $_status) : ?>
                                                        <option <?php $is_edit ? selected($ticket->status, $_status['slug']) : null ?>
                                                                value="<?php echo esc_attr($_status['slug']) ?>"><?php echo esc_html($_status['name']) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="tkt-priority" name="priority">
                                                    <option value="low" <?php $is_edit ? selected($ticket->priority, 'low') : null ?>>
                                                        کم
                                                    </option>
                                                    <option value="medium" <?php $is_edit ? selected($ticket->priority, 'medium') : null ?>>
                                                        متوسط
                                                    </option>
                                                    <option value="high" <?php $is_edit ? selected($ticket->priority, 'high') : null ?>>
                                                        زیاد
                                                    </option>
                                                </select>
                                            </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <select id="tkt-creator-id" name="creator-id">
                                                            <option value="<?php echo esc_attr($ticket->creator_id) ?>"
                                                                    selected><?php echo $creator_data->user_login ?></option>
                                                        </select>
                                                        <a target="_blank"
                                                           href="<?php echo get_edit_user_link($ticket->creator_id) ?>">مشاهده
                                                            پروفایل</a>
                                            ...
                                            <?php if ($is_edit) :
                                                ...
                                                <td>
                                                    ...
                                                    <select id="tkt-user-id" name="user-id">
                                                        <option value="<?php echo esc_attr($ticket->user_id) ?>"
                                                                selected><?php echo $user_data->user_login ?></option>
                                                    </select>
                                                    <a href="<?php echo get_edit_user_link($ticket->user_id); ?>"
                                                       target="_blank">مشاهده پروفایل</a>
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($is_edit) : ?>
                                                    <input type="text" class="tkt-upload-file regular-text"
                                                           id="tkt-ath-file" name="file"
                                                           value="<?php echo esc_attr($ticket->file) ?>">
                                                    <?php if ($ticket->file) : ?>
                                                        <a href="<?php echo esc_attr($ticket->file) ?>" target="_blank">مشاهده
                                                            فایل</a>
                                                    <?php endif; ?>

                                                <?php else : ?>
                                                    <input type="text" class="tkt-upload-file regular-text"
                                                           id="tkt-ath-file" name="file" value="">
                    ...
                    <div class="postbox-container" id="tkt-submit-reply-div">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <input type="text" class="tkt-upload-file regular-text" name="reply-file"
                                ...
                                <?php foreach ($replies as $reply): ?>
                                    <div class="tkt-reply tkt-from-admin">
                                        <div class="tkt-meta tkt-clearfix">
                                            ...
                                            <a href="" class="tkt-user"
                                               target="_blank"> <?= $user_data->display_name ?></a>
                                            <span class="tkt-date"
                                                  dir="ltr"><?= $reply->create_date ?></span>
                                        </div>
                                        ...
                                        <div class="tkt-footer tkt-clearfix">
                                            <input type="text" class="tkt-upload-file regular-text"
                                                   name=" <?= 'reply-file-' . $reply->ID ?>"
                                                   value="<?= esc_attr($reply->file) ?>"
                                                   placeholder="فایل پیوست">

                                            <a href="<?= esc_attr($reply->file) ?>" target="_blank">مشاهده
                                                فایل</a>
                                    ...
                                    <div class="tkt-editor">
                                        <?php wp_editor($reply->body, 'tkt-reply-content' . $reply->ID, ['editor_height' => 250]); ?>
                                    </div>
                                <?php endforeach; ?>
                ...
                <div id="postbox-container-1" class="postbox-container">
                            ...
                            <div id="minor-publishing">
                                <div id="misc-publishing-actions">
                                    ...
                                    <div class="misc-pub-section">
                                        ...
                                        <input type="text" class="regular-text" name="create-date"
                                ...
                                <div class="submitbox" id="submitpost">
                                    <div id="publishing-action">
                                        <input type="submit" name="publish" id="publish"
                                               class="button button-primary button-large" value="ارسال">
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                    ...
                    <div class="postbox" id="tkt-department-div">
                        ...
                        <div class="inside">
                            <div>
                                <?php if (count($parent_department)): ?>
                                    <?php foreach ($parent_department as $parent): ?>
                                        ...
                                        <?php if (count($child_departments)): ?>
                                            <?php foreach ($child_departments as $child): ?>
                                                <label>
                                                    <input <?php $is_edit ? checked($ticket->department_id, $child->ID) : null ?>
                                                            type="radio" name="department-id"
                                                            value="<?= esc_attr($child->ID) ?>">
                                                    <?= esc_html($child->name) ?>
                                                </label>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
